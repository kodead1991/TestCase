...
namespace TestCaseWinforms
{
    public class FrameViewInfo
    {
        ...
        public ushort Mask { get { return mask; } set { mask = value; } }
        public string Structure { get { return structure; } set { structure = value; } }
        public FrameViewInfo(ushort mask, string structure)
        {
    ...
    {
        public Frame drawFrame;
        public FrameViewInfo frameInfo;
        private string radix;

        public string Radix { get { return radix; } set { radix = value; } }
        ...
        //{
        //    if (drawFrame == null || drawFrame.Length == 0)
        //        return;
